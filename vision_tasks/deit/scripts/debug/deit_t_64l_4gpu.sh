#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# DeiT-Tiny depth-scaling baseline (64-layer full-attention ViT) -- LOCAL
# DEBUG variant of ``scripts/train/deit_t_64l_4gpu.sh``.
#
...
#   * Model: ``deit_tiny_64l_patch16_224`` (embed_dim=192, num_heads=3,
#     depth=64, mlp_ratio=4, patch16, img224)
...
#
# Run:
#   bash vision_tasks/deit/scripts/debug/deit_t_64l_4gpu.sh
# -----------------------------------------------------------------------------
set -euo pipefail
